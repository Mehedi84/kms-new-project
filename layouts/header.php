...
<html lang="en">
  <head>
    ...
    <title>10MS KMS | <?php echo ($titleHeader) ? ($titleHeader) : ("Home"); ?></title>
    <!-- Google font-->
      ...
      <div class="page-header row">
        <div class="header-logo-wrapper col-auto">
          <div class="logo-wrapper"><a href="index.html">
            <img class="img-fluid for-light" src="assets/images/logo/download.png" alt=""/>
            <img class="img-fluid for-dark" src="assets/images/logo/10ms-black.png" alt=""/></a></div>
        </div>
        <!-- Page Header Start-->
              ...
              <ul class="nav-menus">
                ...
                <li class="profile-nav onhover-dropdown px-0 py-0">
                  <div class="d-flex profile-media align-items-center"><img class="img-30" src="assets/images/dashboard/profile.png" alt="">
                    <div class="flex-grow-1"><span>Mehedi Hasan Shamim</span>
                      <p class="mb-0 font-outfit">Web Developer<i class="fa fa-angle-down"></i></p>
                    </div>
                  </div>
                  <ul class="profile-dropdown onhover-show-div">
                    ...
                    <li><a href="actions/logout_action.php"><i data-feather="log-in"> </i><span>Log out</span></a></li>
                  </ul>
                </li>
              </ul>
            </div>
