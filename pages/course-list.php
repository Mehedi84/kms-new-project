            ...
            <div class="row">
                    ...
                    <div class="card">
                      <div class="blog-box blog-grid text-center product-box">
                        ...
                        <div class="blog-details-main">
                          ...
                          <hr>
                          <h5 class="f-w-600">Web Devlopment.</h5>
                          <p class="blog-bottom-details">This course is designed to start you on a path toward future studies in web development and design.</p>
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="card">
                      <div class="blog-box blog-grid text-center product-box">
                        ...
                        <div class="blog-details-main">
                          ...
                          <p class="blog-bottom-details">Web designing course belongs to the field of computer science and IT. It enables students to learn.</p>
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="card">
                      <div class="blog-box blog-grid text-center product-box">
                        ...
                        <div class="blog-details-main">
                          ...
                          <p class="blog-bottom-details">User interface design (UI) is the design for machines and software, such as mobile devices, computers.</p>
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="card">
                      <div class="blog-box blog-grid text-center product-box">
                        ...
                        <div class="blog-details-main">
                          ...
                          <hr>
                          <h5 class="f-w-600">Spoken English</h5>
                          <p class="blog-bottom-details">Spoken english courses are pursued by candidates from all levels to improve their communication skills.</p>
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="card">
                      <div class="blog-box blog-grid text-center product-box">
                        ...
                        <div class="blog-details-main">
                          ...
                          <hr>
                          <h5 class="f-w-600">Advance Design.</h5>
                          <p class="blog-bottom-details">Web development course belongs to the field of computer science and IT. It enables students to learn.</p>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div class="col-xl-3 xl-40 box-col-12 learning-filter">
                <div class="md-sidebar"><a class="btn btn-primary email-aside-toggle md-sidebar-toggle">Learning filter</a>
                  <div class="md-sidebar-aside job-sidebar job-default-sidebar">
                          ...
                          <div class="card">
                            ...
                            <div class="collapse card-body px-0 show" id="collapseicon1" aria-labelledby="collapseicon1" data-bs-parent="#accordion">
                              <div class="categories">
                                <div class="learning-header"><span class="pt-3 f-w-600">Design</span></div>
                                <ul>
                              ...
                              <div class="categories pt-0">
                                <div class="learning-header"><span class="pt-3 f-w-600">Development</span></div>
                                <ul>
                          ...
                          <div class="card">
                            ...
                            <div class="collapse show" id="collapseicon2" aria-labelledby="collapseicon2" data-bs-parent="#accordion">
                              <div class="upcoming-course card-body">
                                <div class="d-flex">
                                  <div class="flex-grow-1"><span class="f-w-600">UX Development</span><span class="d-block">Course By <a href="#">Howard Moore</a></span><span class="d-block"><i class="fa fa-star font-warning"></i><i class="fa fa-star font-warning"></i><i class="fa fa-star font-warning"></i><i class="fa fa-star font-warning"></i><i class="fa fa-star-half-o font-warning"></i></span></div>
                                  <div>
                                    <h5 class="mb-0 font-primary">18</h5><span class="d-block">Dec</span>
                                  </div>
                                </div>
                                <div class="d-flex">
                                  <div class="flex-grow-1"><span class="f-w-600">Business Analyst</span><span class="d-block">Course By <a href="#">Crystal Markey</a></span><span class="d-block"><i class="fa fa-star font-warning"></i><i class="fa fa-star font-warning"></i><i class="fa fa-star font-warning"></i><i class="fa fa-star font-warning"></i><i class="fa fa-star font-warning"></i></span></div>
                                  <div>
                                    <h5 class="mb-0 font-primary">28</h5><span class="d-block">Dec</span>
                                  </div>
                                </div>
                                <div class="d-flex">
                                  <div class="flex-grow-1"><span class="f-w-600">Web Development</span><span class="d-block">Course By <a href="#">Jerry Reel </a></span><span class="d-block"><i class="fa fa-star font-warning"></i><i class="fa fa-star font-warning"></i><i class="fa fa-star font-warning"></i><i class="fa fa-star font-warning"></i><i class="fa fa-star-o font-warning"></i></span></div>
                                  <div>
