              ...
              <div id="sidebar-menu">
                <ul class="sidebar-links" id="simple-bar">
                  ...
                  <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title" href="javascript:void(0)">
                      ...
                      <svg class="fill-icon">
                        <use href="assets/svg/icon-sprite.svg#fill-learning"></use>
                      </svg><span>Course calender</span></a>
                    <ul class="sidebar-submenu">
                      <li><a href="./index.php?p=course-list">Course List</a></li>
                      <li><a href="course-detailed.html">Course Details</a></li>
                    </ul>
                  </li>
                  <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title" href="javascript:void(0)">
                      ...
                      <svg class="fill-icon">
                        <use href="assets/svg/icon-sprite.svg#fill-learning"></use>
                      </svg><span>Social calender</span></a>
                    <ul class="sidebar-submenu">
                      <li><a href="./index.php?p=course-list">Course List</a></li>
                      <li><a href="course-detailed.html">Course Details</a></li>
                    </ul>
                  ...
                  <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title" href="javascript:void(0)">
                      ...
                      <svg class="fill-icon">
                        <use href="assets/svg/icon-sprite.svg#fill-learning"></use>
                      </svg><span>SOP against CQC</span></a>
                    <ul class="sidebar-submenu">
                      <li><a href="./index.php?p=course-list">Course List</a></li>
                      <li><a href="course-detailed.html">Course Details</a></li>
                    </ul>
                  ...
                  <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title" href="javascript:void(0)">
                      ...
                      <svg class="fill-icon">
                        <use href="assets/svg/icon-sprite.svg#fill-learning"></use>
                      </svg><span>Pricing and Promos</span></a>
                    <ul class="sidebar-submenu">
                      <li><a href="./index.php?p=course-list">Course List</a></li>
                      <li><a href="course-detailed.html">Course Details</a></li>
                    </ul>
                  ...
                  <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title" href="javascript:void(0)">
                      ...
                      <svg class="fill-icon">
                        <use href="assets/svg/icon-sprite.svg#fill-learning"></use>
                      </svg><span>SMS/IVR information</span></a>
                    <ul class="sidebar-submenu">
                      <li><a href="./index.php?p=course-list">Course List</a></li>
                      <li><a href="course-detailed.html">Course Details</a></li>
                    </ul>
